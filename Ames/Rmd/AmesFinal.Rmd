...
```{r Initial_Scatter_plots, echo=FALSE}
...
```{r Log_Linear_SP,echo=FALSE, fig.height=10, fig.width=10}
...
```{r Log_log, echo=FALSE, fig.height=10, fig.width=10}
...
```{r corHeatMap, echo=FALSE, fig.height=10, fig.width=10}
...
```{r RandomForrest,echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=10}
...
```{r runningForwardSelection, echo=FALSE, warning=FALSE, message=FALSE}
library(leaps)
...
```{r EDAScatterplots, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4}
library("gridExtra")
...
```{r Residual_Plotting, echo=FALSE, warning=FALSE, message=FALSE}
