...
##COULD GO THROUGH UNLOGGED TO SHOW ITS WORSE.  BUT PROBABLY NOT
...
Now we'll look at the residual diagnostics of our non-additive two way anova to get an understanding of the residual plots to further check our assumptions.  
...
```
  ...
  * Constant Variance - Looking at the residuals plot it seems to have a fairly even distribution between the groups.  
