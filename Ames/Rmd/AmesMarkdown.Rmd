...
First off, we need to go through and do a little house cleaning with the data.  The following chunks will take you that initial process before we get to some of the graphing and other aspects of what we need to accomplish.  
```{r Dataload}
