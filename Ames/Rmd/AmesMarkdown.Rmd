...
ggplot(Clean.train, aes(x = TotalSqFt_100, y = SalePrice)) +
        geom_point(shape=1) + 
...
ano.fit <-aov(log(SalePrice)~TotalSqFt_100+GarageType+TotalSqFt_100:GarageType,data=Clean.train)
...
plot3<-ggplot(myfits, aes(x=residuals)) + 
  geom_histogram(aes(y=..density..),binwidth=100,color="black", fill="gray")+
